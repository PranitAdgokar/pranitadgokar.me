...
function hero() {
    ...
    //     <>
    //         <div className="flex ">
    //             <div className="h-2/3 w-[calc(100%-4rem)] mt-10 flex flex-col justify-center items-center">
    //                 <img
    //                     src="https://avatars.githubusercontent.com/u/136226664"
    //                     alt="hero"
    //                     className="rounded-full w-52 h-52"
    //                 />
    //                 <h1 className=" text-4xl font-bold text-center mt-10 mb-5">
    //                     Hi, I'm Pranit Adgokar <br /> A Full Stack Developer
    //                 </h1>
    //                 <Button variant="outline">Contact Me</Button>
    //             </div>
    //             <div className="social-icon mt-10 flex flex-col justify-center gap-6">
    //                 <a
    ...
    //             </div>
    //         </div>
    //         <div className="social-icon flex flex-col justify-start">
    //             <div className="inline-flex">
    //                 <Map className="text-muted-foreground mr-2" size={24} />

    //                 <WordRotate
    //                     className="text-muted-foreground text-md w-full text-center font-bold leading-none tracking-tighter"
    //                     words={[
    //                         'Web Development.',
    //                         'Mobile Development.',
    //                         'Backend Development.',
