        ...
        <>
            <div className="flex flex-col items-start justify-start divide-y divide-accent-foreground dark:divide-accent md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6 md:divide-y-0">
                <div className="space-x-2 pb-8 pt-6 md:space-y-5">
                    <h1 className="text-3xl font-extrabold leading-9 tracking-wide text-foreground sm:text-4xl sm:leading-10 md:border-r-2 md:px-6 md:text-6xl md:leading-14">
                        Tags
                    </h1>
                </div>
                    ...
                    {sortedTags.map((t) => {
                        return (
                            <div key={t} className="mb-2 mr-5 mt-2">
                                ...
                                <Link
                                    href={`/tags/${slug(t)}`}
                                    className="-ml-1 text-lg font-semibold uppercase text-muted-foreground"
